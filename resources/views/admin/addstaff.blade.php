          ...
          <div class="col-sm-12">
              <div class="panel panel-bd lobidrag">
                  <div class="panel-heading">
                      <div class="btn-group"> 
                          <a class="btn btn-primary" href="{{ url('/doctors') }}"> <i class="fa fa-list"></i>  Staff List </a>  
                      </div>
                  </div>
                      ...
                      <form class="col-sm-12" method="POST" action="{{ url('doctors') }}"  enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="unique_id" value="{{ $random_number }}">
                          ...
                          <div class="col-sm-6 form-group">
                              ...
                              <select name="designation" class="form-control" id="exampleSelect1" name="select" size="1">
