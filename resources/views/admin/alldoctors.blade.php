            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group"> 
                            <a class="btn btn-success" href="{{ url('doctors') }}"> <i class="fa fa-plus"></i> Add Doctor
                            </a>  
                        </div>        
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <label>{{ $doctor->unique_id }}</label>   
                                        </td>
                                     
                                        <!--<td>
                                            <img src="storage/{{ $doctor->photo }}" class="img-circle" alt="User Image" height="50" width="50">
                                        </td>-->
                                        ...
                                        <td>
                                            <a href="{{ url('/') }}/editdoctor/?unique_id={{ $doctor->unique_id }}" class="btn btn-info btn-xs">Profile</a>
                                      
                                            <a href="{{ url('/') }}/doctorschedule/?unique_id={{ $doctor->unique_id }}" class="btn btn-pink btn-xs">Schedules</a>
                                            @if($doctor->status=="1")
                                                <a href="{{ url('/') }}/ban/?unique_id={{ $doctor->unique_id }}" class="btn btn-inverse btn-xs">Ban</a>
                                            @else
                                                <a href="{{ url('/') }}/ban/?unique_id={{ $doctor->unique_id }}" class="btn btn-warning btn-xs">Unban</a>
                                            @endif
                                        </td>
